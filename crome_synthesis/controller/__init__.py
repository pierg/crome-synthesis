...
class Controller:
    ...
    def __post_init__(self):
        ...
        self._info = ControllerInfo.from_ltl(self.assumptions, self.guarantees)

        self._typeset = self.assumptions.typeset_complete + self.guarantees.typeset_complete
        ...
        file_path = save_to_file(
            file_content=self._info.to_str, file_name="controller"
        )
        print(file_path)

        a, g, i, o = self._info.to_strix
